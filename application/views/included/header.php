              ...
              <ul class="social-icons icon-sm sm-text-center">
              	<?php
              		if( current_url()==base_url('/') )
              		{
              			...
              			echo "<li><a href=".base_url()."><i class='fa fa-home fa-2x'></i></a></li>";
              		}
              	?>
              	<li><?php echo $this->lang->line('welcome_message');?></li>
...
<<<<<<< HEAD
                ...
                <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope text-theme-colored"></i>
                  <a class="text-gray" href="javascript:;" data-toggle="modal" data-target="#commentForm"><?php echo $this->lang->line('Comment');?></a>
                </li>
                <li class="m-0 pl-10 pr-10"> <i class="fa fa-exclamation-circle text-theme-colored"></i> <a class="text-gray" href="#" onclick="aggrement('crime')"><?php echo $this->lang->line('FIR Report');?></a> </li>
                ...
                <!-- <li class="m-0 pl-10 pr-10">
                  <a href="<?php echo base_url(); ?>LanguageSwitcher/switchLang/አማርኛ" class="text-gray" onclick="language()"><span class="flag-icon flag-icon-et"></span> አማርኛ</a>
                </li> -->
                <li class="m-0 pl-10 pr-10 nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a style="color: #333!important;" href="<?php echo base_url(); ?>LanguageSwitcher/switchLang/አማርኛ" class="text-gray dropdown-item m-0 pl-10 pr-10"><span class="flag-icon flag-icon-et"></span> አማርኛ</a>
                    <br>
                    <a style="color: #333!important;" href="<?php echo base_url(); ?>LanguageSwitcher/switchLang/english" class="text-gray dropdown-item m-0 pl-10 pr-10" ><span class="flag-icon flag-icon-gb"></span> English</a>
