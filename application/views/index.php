  ...
  <div class="container pb-30">
    ...
    <div class="section-content">
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 mb-30">
          <div class="box-hover-effect effect2 bg-lightest-gray wow fadeInUp maxwidth400 p-10" data-wow-duration="1.5s" data-wow-offset="10">
            <div class="thumb"> <img class="img-responsive img-fullwidth" src="<?php echo base_url()?>assets/images/emw2.png" alt="featured project"  width="476" style="min-width: auto; min-height: auto; max-height: 320px!important; max-width: 95%;">
              <div class="overlay black">
                <div class="display-table">
                  <div class="display-table-cell">
                    <div class="overlay-details text-center">
