    ...
    <div class="col-lg-9" style="overflow: auto;">
        <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
                <h3 class="panel-title" align="center">Edit Criminal And Suspects Information</h3>
            </div>
            ...
            class="form-control" oninput="image(this.value)"  value="" />
                    ...
                    <select class="form-control" id="recipient-dob" name="criminal_birthdate">
                     <option value="10-20 Years" <?php if($criminal[0]->criminal_birthdate=='10-20 Years'){echo 'selected';}?>>10-20 Years</option>
                     <option value="20-30 Years" <?php if($criminal[0]->criminal_birthdate=='20-30 Years'){echo 'selected';}?>>20-30 Years</option>
                     <option value="30-40 Years" <?php if($criminal[0]->criminal_birthdate=='30-40 Years'){echo 'selected';}?>>30-40 Years</option>
                     <option value="40-50 Years" <?php if($criminal[0]->criminal_birthdate=='40-50 Years'){echo 'selected';}?>>40-50 Years</option>
                     <option value="50-60 Years" <?php if($criminal[0]->criminal_birthdate=='50-60 Years'){echo 'selected';}?>>50-60 Years</option>
                     <option value="60-70 Years" <?php if($criminal[0]->criminal_birthdate=='60-70 Years'){echo 'selected';}?>>60-70 Years</option>
                     <option value="70-80 Years" <?php if($criminal[0]->criminal_birthdate=='70-80 Years'){echo 'selected';}?>>70-80 Years</option>
                     <option value="Above 80 Years" <?php if($criminal[0]->criminal_birthdate=='Above 80 Years'){echo 'selected';}?>>Above 80 Years</option>
                    </select>
                    ...
                    placeholder="e.g Murder" class="form-control" name="criminal_type" value="<?php echo set_value('criminal_type',$criminal[0]->criminal_type) ?>">
                    ...
                    <span style="color: red;"><?php echo form_error('criminal_reward','<span style="color:red">','</span>') ?></span>
				        		...
				        		<div class="col-md-12">
						          <div class="form-group">
						            <label for="editor2" class="col-form-label">Description About Fugitive</label>
